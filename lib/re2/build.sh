...
# After running make, in the obj directory, run 'extract-bc', passing in the name of the archive in the directory
# Then copy this script into the 'obj' directory and run it from there.
